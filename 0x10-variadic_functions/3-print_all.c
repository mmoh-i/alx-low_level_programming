 ...
 * @list: The  va_list passed to function
 */
void _printchar(va_list array)
{
 ...
 * @list: va_list passed to function
 */
void _printfloat(va_list array)
{
